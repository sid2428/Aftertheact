  ...
  return (
    <div className="glass-surface grid grid-cols-3 gap-0 divide-x divide-white/10 text-center rounded-2xl overflow-hidden">
      <div className="p-3 sm:p-5">
        <div className="flex items-center justify-center leading-tight min-h-[2.6em] text-[10px] sm:text-xs font-display font-black uppercase tracking-widest text-white/40 mb-1">Self Score</div>
      ...
      <div className="p-3 sm:p-5">
        <div className="flex items-center justify-center leading-tight min-h-[2.6em] text-[10px] sm:text-xs font-display font-black uppercase tracking-widest text-white/40 mb-1">Panel Score</div>
      ...
      <div className="p-3 sm:p-5 bg-white/[0.03] text-white relative">
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-center leading-tight min-h-[2.6em] text-[10px] sm:text-xs font-display font-black uppercase tracking-widest text-latent-crimson mb-1">Crowd Score</div>

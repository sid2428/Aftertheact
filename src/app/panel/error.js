  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center p-6">
      <div className="max-w-md w-full text-center bg-[#111111] border border-latent-crimson/30 rounded-md p-10">
        <div className="font-display font-black uppercase tracking-widest text-latent-crimson text-sm mb-4">The jury has recused itself</div>
        <h1 className="font-display font-black uppercase tracking-tight text-white text-3xl mb-3">Couldn&apos;t load the panel</h1>
